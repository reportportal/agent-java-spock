...
import com.epam.reportportal.spock.features.fixtures.CleanupSpecFixture;
...
public class TestCleanupSpecFixtureIntegrity {
	...
	@Test
	public void verify_spec_fixture_correct_reporting() {
		TestExecutionSummary result = runClasses(CleanupSpecFixture.class);
