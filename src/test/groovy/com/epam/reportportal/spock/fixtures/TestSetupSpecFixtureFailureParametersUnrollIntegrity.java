...
import com.epam.reportportal.spock.features.fixtures.SetupSpecFixtureFailedParametersUnroll;
...
public class TestSetupSpecFixtureFailureParametersUnrollIntegrity {
	...
	public void verify_setup_spec_failure_parameters_unroll_correct_reporting() {
		TestExecutionSummary result = runClasses(SetupSpecFixtureFailedParametersUnroll.class);
		...
		verify(client, times(2)).startTestItem(same(classId), startFeatureCaptor.capture());
